...
public class Main {
    ...
    static int paso_rango=0;
    static int dato_no_num=0;
    ...
    public static void main(String[] args) {
        ...
        while(intentos<limiteIntentos){
            ...
            if(numero==secreto){
                ...
                gano=true;
                System.out.println("Te pasaste fuera del rango: "+paso_rango+" veces");
                System.out.println("Ingresaste : "+dato_no_num+" datos no numericos");
                break;
